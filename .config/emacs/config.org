...
#+PROPERTY: header-args :tangle ./init.el :comments both :padline
#+AUTO_TANGLE: t
...
(defvar macbook-hostname "rossedwards")
  ...
  (dolist (frame-setting
	   `((fullscreen . maximized)
	     (alpha-background . ,(pcase (system-name)
				    ...
				    ((or (pred (string-equal other-laptop-hostname))
...
(use-package lsp-mode
  :init (setq lsp-keymap-prefix "C-c c")
  :hook
