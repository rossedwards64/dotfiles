...
(use-package catppuccin-theme
  :config (ross/set-theme 'catppuccin))
...
(use-package org
  ...
  (setq org-directory "~/Documents/org"
        ...
        org-agenda-custom-commands '(("i" "Inbox"
                                      ((todo ".*" ((org-agenda-files `(,(concat org-directory "/todo.org")))
...
#+begin_src emacs-lisp :tangle no
(when (nixos-p)
  (setq elpaca-core-date 20241026)) ;; update this on the next emacs release
