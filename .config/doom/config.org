...
(use-package! dashboard
  ...
  (setq dashboard-set-heading-icons t
        ...
        dashboard-banner-logo-title "[ Ω Ο Ρ Μ  Δ Ι Τ Ι Ο Ν ]"
...
(custom-set-faces!
  ...
  '(dashboard-navigator-buttons :inherit font-lock-string-face))
...
(setq user-full-name "Ross Edwards"
      ...
      ranger-listing-switches "-agho --group-directories-first"
      dired-omit-mode t
