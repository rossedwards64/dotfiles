...
(defun old-reddit-redirect (request-data)
...
(define-configuration buffer
  ((request-resource-hook
    (reduce #'hooks:add-hook
            (mapcar #'make-handler-resource (list #'old-reddit-redirect))
    ...
    ((remote-execution-p t)
     (external-editor-program
      (list "emacsclient" "-cn" "-a" "" "-F"
            "((font . \"Iosevka Nerd Font-18\") (vertical-scroll-bars) (tool-bar-lines) (menu-bar-lines))"))))
